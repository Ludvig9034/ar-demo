...
const faqs = [
  ...
  { q: 'Ejer vi selv oplevelsen bagefter?', a: 'Ja. Du får leveret både kildefiler, 3D-assets og hosting-opsætning. Vi kan også stå for drift og iterationer, hvis ønsket.' },
];
